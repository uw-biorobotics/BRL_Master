...
//#define ADDR_SAME_PC	"128.95.31.178"
...
#define SCALE_INIT_VALUE 5	//5 means 0.05
...
typedef struct _stUI2MA_DATA{
	_stUI2MA_DATA() : flag01(0){ camAngle[0]=camAngle[1]=camAngle[2]=0;};
	unsigned int tick;
	int flag01;
	int UDPaddr; 
	int scale;
